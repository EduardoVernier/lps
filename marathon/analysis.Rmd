...
The graph below compares finishing times between men and women. Because the number of male and female runners differ, the histograms have been normalized.
...
ggplot(df, aes(df$Official.Time, fill = df$Gender)) +
  ...
  scale_fill_discrete(name="Gender", breaks=c("F", "M"), labels=c("WOMEN", "MEN")) + 
  theme_bw()
```
...
(Claim 3 is based observing a subsample of the space, maybe for the whole population this isn't true, we would need to run more tests to be sure about the claim.)
